...
target :iNaturalist do
  ...
  pod 'JWT', '2.2.0'
  pod 'FontAwesomeKit', :git => 'https://github.com/inaturalist/FontAwesomeKit', :commit => '74fe81b8a0a855e6d9cf62f29f02b47237fab25c'
  pod 'HexColors', '2.3.0'
  pod 'BlocksKit', '2.2.5'
  ...
  pod 'Mantle', '1.5.8'
  pod 'ICViewPager', :git => 'https://github.com/inaturalist/ICViewPager.git', :commit => '4c45423b6a36fb38753af86a1050b6a3a1d548b8'
  pod 'Realm', '~>10'
