...
- (NSArray *)sortedActivity {
    ...
    NSArray *unhiddenComments = [comments filteredArrayUsingPredicate:notHiddenPredicate];
    NSArray *unhiddenIds = [identifications filteredArrayUsingPredicate:notHiddenPredicate];
