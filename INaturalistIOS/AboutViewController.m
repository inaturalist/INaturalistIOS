...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    header.headerBodyLabel.text = [NSString stringWithFormat:@"%@\n\n%@\n\n%@\n\n%@\n\n%@\n\n%@",
                                   ...
                                   NSLocalizedString(@"Caltech and Cornell Tech helped developed the computer vision system that recognizes species from photographs. We thank Grant Van Horn, Serge Belongie and Pietro Perona for this work. More information may be found at visipedia.org. Special thanks to NVIDIA for additional assistance with our computer vision system.", @"vision assistance"),
